...
/* put scheduled terminal cursor at given place */
void place_cursor_for_term(uint32_t x, uint32_t y);

/* change the video memory content of the scheduled terminal */
...
/* set the cursor with correct place */
extern void place_cursor(unsigned int x,unsigned int y);

/* clear the line */
extern void clear_line(signed line,unsigned int rm_length);
