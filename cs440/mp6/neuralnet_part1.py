...
class NeuralNet(torch.nn.Module):
    def __init__(self, lrate,loss_fn,in_size,out_size):
        ...
        self.fc5 = nn.Linear(128, out_size)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.batch1(self.fc3(x)))
        x = F.relu(self.batch1(self.fc4(x)))
        x = self.fc5(x)
        return x
...
def fit(train_set,train_labels,dev_set,n_iter,batch_size=200):
    ...
    neural_network = NeuralNet(0.0001, loss, len(train_set[0]), 2)
