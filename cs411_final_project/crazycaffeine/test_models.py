...
class ProjectDrinks(models.Model):
    drink_name = models.CharField(max_length=200)
    fl_oz = models.DecimalField(max_digits=7, decimal_places=2)
    g_sugar = models.DecimalField(max_digits=7, decimal_places=2)
    g_floz = models.DecimalField(max_digits=7, decimal_places=2)
    mg_caffeine = models.PositiveIntegerField()
    mg_floz = models.DecimalField(max_digits=7, decimal_places=2)

    class Meta:
        managed = False
        db_table = 'project_drinks'
