...
module lab8_soc_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [102:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> sdram_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> keycode_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> otg_hpi_address_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> otg_hpi_data_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> otg_hpi_r_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> otg_hpi_w_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> otg_hpi_cs_s1_agent:cp_data
	...
	wire  [102:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> otg_hpi_reset_s1_agent:cp_data
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> led_s1_agent:cp_valid
	wire  [102:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> led_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> led_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> led_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> led_s1_agent:cp_endofpacket
	...
	wire  [102:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [102:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [102:0] keycode_s1_agent_rp_data;                                                           // keycode_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] otg_hpi_address_s1_agent_rp_data;                                                   // otg_hpi_address_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [102:0] otg_hpi_data_s1_agent_rp_data;                                                      // otg_hpi_data_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [102:0] otg_hpi_r_s1_agent_rp_data;                                                         // otg_hpi_r_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [102:0] otg_hpi_w_s1_agent_rp_data;                                                         // otg_hpi_w_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [102:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [102:0] otg_hpi_reset_s1_agent_rp_data;                                                     // otg_hpi_reset_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [102:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_015:sink_data
	...
	wire          led_s1_agent_rdata_fifo_src_valid;                                                  // led_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] led_s1_agent_rdata_fifo_src_data;                                                   // led_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          led_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_013:in_0_ready -> led_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> led_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> led_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // led_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> led_s1_agent:rdata_fifo_sink_error
